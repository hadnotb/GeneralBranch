...
for(let i = 0; i < phrases.length; i++){
    ...
    if (phrases[i].length > phrases[laPlusLongue].length){
...
console.log(phrases[laPlusLongue]);

document.write(

    "<p>" + "La phrase la plus longue est '" + phrases[laPlusLongue] +"'." +
    
    "Et celle ci fait " + laPlusLongue + " charactere." +
