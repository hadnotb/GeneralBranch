...
for (let indexCur = 0; indexCur < phrases.length; indexCur++) {
    /*
     * phrases représente le tableau de toutes les phrases
     * phrases[index] représente un élément du tableau, la phrase "courante", celle actuellement examinée
     *
     ...
     * (en utilisant la variable indexPhraseLaPlusLongue)
     */
    if (phrases[indexCur].length > phrases[indexMax].length) {
        /*
