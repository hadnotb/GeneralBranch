...
// On parcours le tableau de phrases
for (let i = 0 ; i < phrases.length ; i++) {

    // Si on veut récupérer la taille de la phrase courante (la ième phrase)
    console.log(`La longueur de la phrase d'indice ${i}  est ${phrases[i].length}`);
}
